...
$channelauthor  = "Podcastbetreiber";
...
foreach ($mp3files as $filename) {
  ...
  print "
  <item>
    <title>".$iteminfo['TPE1']." - ".$iteminfo['TIT2']."</title>
    <itunes:author>".$iteminfo['TPE1']."</itunes:author>
    <itunes:subtitle>".$iteminfo['TALB']."</itunes:subtitle>
    <description>".$iteminfo['TIT2']." by ".$iteminfo['TPE1']." Recorded on ".date ("r", filemtime($filename))."</description>
